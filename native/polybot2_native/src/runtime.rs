...
impl NativeHotPathRuntime {
    ...
    fn start(
        ...
        let engine: SportEngine = match sport {
            ...
            "cs2" => {
                let mut e = crate::cs2::types::NativeCs2Engine::new();
                e.load_plan_from_json(compiled_plan_json)
                ...
                for pc in provider_configs {
                    match pc.provider.as_str() {
                        ...
                        "boltodds" => {
                            ...
                            // BoltOdds labels arrive dynamically via SetCandidateSubscriptions
                            // (candidate_subs.get("boltodds")), same routing as V1/V2.
                            // Pass empty here; the worker will populate from candidate_subs.
